...
class ShowBloodSugarDialog extends StatelessWidget {
  final HistoryController controller;
  final HistoryBloodsugarModel item;
  const ShowBloodSugarDialog({
    super.key,
  ...
  Widget build(BuildContext context) {
    final sugarController = TextEditingController(
      text: item.bloodSugarData.toString(),
    );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(sugarController, "117", isNumeric: true),
            const SizedBox(height: 22),
            _label("Context"),
            _buildTextField(contextController, "After Dinner"),
            const SizedBox(height: 32),
            SizedBox(
              width: double.infinity,
              child: ElevatedButton(
                onPressed: () {
                  controller.updateBloodSugar(
                    item,
